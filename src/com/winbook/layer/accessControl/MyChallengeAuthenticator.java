 ...
 */
public class MyChallengeAuthenticator extends Authenticator {
     ...
     *            The authentication realm.
     * 
     * @see #MyChallengeAuthenticator(Context, boolean, ChallengeScheme, String,
     *      Verifier)
     */
    public MyChallengeAuthenticator(Context context, boolean optional,
     ...
     *      Verifier)
     */
    public MyChallengeAuthenticator(Context context,
            ChallengeScheme challengeScheme, String realm) {
    ...
    protected boolean authenticate(Request request, Response response) {
        ...
        if (getVerifier() != null) {
        	...
        	int resultV = v.verify(request, response);
            switch (resultV) {
...
//		TemplateRepresentation loginPage = factory.getLoginRepresentation(this.request, "Please log in to access the requested page...");
//		response.setStatus(Status.CLIENT_ERROR_UNAUTHORIZED);
